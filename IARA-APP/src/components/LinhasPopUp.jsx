...
function LinhasPopUp(props) {
    ...
    if (infoHorario.length !== 0) {
        if (infoHorario.length === 2) {
            return (
                <>
                    <div className="modal-content">
                        <LinhaServicosPopUp
                            horaInicioMinima1={infoHorario[0].horaInicioMinima + " e"}
                            horaInicioMaxima1={infoHorario[0].horaInicioMaxima}
                            horaInicioMinima2={infoHorario[1].horaInicioMinima + " e"}
                            horaInicioMaxima2={infoHorario[1].horaInicioMaxima}
                        />
                    </div>
                </>
            );
