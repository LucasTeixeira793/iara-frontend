        ...
        <div class="card prelative">
            <div class="dflex acenter jbetween">
                ...
                <div class="dflex acenter jbetween">
                    ...
                    <label for="favorite" class="button box-shadow-none-hover shadow-smooth label-fav container bg-red txt-white bg-hover-white txt-hover-dark-red margin-none margin-right-twenty">
